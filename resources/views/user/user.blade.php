                ...
                <div class="up-consult-card group bg-white border-2 border-slate-100 p-7 rounded-[2.5rem] transition-all duration-500 hover:border-blue-500 hover:shadow-[0_20px_50px_-20px_rgba(16,185,129,0.2)]"data-aos="fade-up" data-aos-delay="100">
                    ...
                    @if(session('login_user') && session('user_id'))
                        <a href="{{ route('konsultasi.index') }}" class="block w-full">
                            <button class="flex items-center justify-between w-full p-4 bg-blue-500 text-white rounded-2xl text-[9px] font-black uppercase tracking-widest shadow-lg shadow-blue-50 hover:bg-blue-600 transition-all speak-target" onmouseenter="speakOnHover(this)">
                    ...
                    @else
                        <button type="button" onclick="showLoginAlert()" class="flex items-center justify-between w-full p-4 bg-blue-500 text-white rounded-2xl text-[9px] font-black uppercase tracking-widest shadow-lg shadow-blue-50 hover:bg-blue-600 transition-all speak-target">
                            <span>Hubungi Pakar</span>
                            <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="3" d="M17 8l4 4m0 0l-4 4m4-4H3"/></svg>
                        </button>
                    @endif
                ...
                <div class="up-consult-card group bg-white border-2 border-slate-100 p-7 rounded-[2.5rem] transition-all duration-500 hover:border-blue-500 hover:shadow-[0_20px_50px_-20px_rgba(59,130,246,0.2)]" data-aos="fade-up" data-aos-delay="200">
                    ...
                    <div class="flex flex-row gap-2">
                        <div class="flex-[2]"> 
                            ...
                            @else
                                <button type="button" onclick="showLoginAlert()" class="w-full p-4 bg-blue-500 text-white rounded-2xl text-[9px] font-black uppercase tracking-tight shadow-lg shadow-blue-50 hover:bg-blue-600 transition-all flex items-center justify-between">
                                    <span>Atur Jadwal</span>
                                    <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="3" d="M17 8l4 4m0 0l-4 4m4-4H3"/></svg>
                                </button>
                            @endif
