...
<div class="w-full p-6 bg-gray-100 min-h-screen">
    <div class="w-full  bg-white rounded-lg shadow-md overflow-hidden">
        <div class="bg-blue-300 p-4">
            <h2 class="text-xl font-bold text-blue-800">Buat Manajemen Mutu</h2>
        </div>

        <form method="POST" action="{{ route('manajemen-mutu.store') }}" class="p-6" enctype="multipart/form-data">
            @csrf
            ...
            <div class="mb-4">
                ...
                <input type="text" name="kategori" placeholder="Masukkan kategori" id="kategori" class="w-full px-4 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-300" value="{{ old('kategori') }}" required>
                    @error('kategori')
            ...
            <div class="mb-4">
                <label for="file" class="block text-gray-700 font-medium mb-2">File pdf|Jpg|Png</label>
